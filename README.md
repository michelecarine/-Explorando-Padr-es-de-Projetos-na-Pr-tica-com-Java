...
<p align="center">
	<img alt="Repository language count" src="https://img.shields.io/github/languages/count/michelecarine/lab-padroes-projeto-java-spring">
	<a href="https://www.linkedin.com/in/michele-silva-274b1a231/">
		<img alt="Made by Michele" src="https://img.shields.io/badge/made%20by-Michele-red">
	</a>
	<a href="https://github.com/michelecarine/lab-padroes-projeto-java-spring/commits/master">
		<img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/michelecarine/lab-padroes-projeto-java-spring?color=blue">
	</a>
...
```JSON
{
  "name": "Livraria Pernambuco",
  "ean": "0058771387587",
  "unity": "Peça",
  "distributors": [
    {
      "name": "Livraria Pernambuco",
      "comments": "Livros para todos",
      "address": {
        "cep": "06447130"
      },
      "addressNumber": 800
